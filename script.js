...
function generatePassword() {
  alert(
    "Answer the following questions in order to generate your random password."
  );
  ...
  while (inValid) {
    ...
    if (passwordLength >= 8 && passwordLength <= 128) {
      ...
      alert(
        "Invalid input. Please recheck character parameters and try again."
      );
    }
  }
  alert(
  ...
  while (!inValid) {
    ...
    if (
      ...
      alert(
        "Invalid selection. At least one option must be selected. Please recheck parameters and try again"
      );
    }
  }
